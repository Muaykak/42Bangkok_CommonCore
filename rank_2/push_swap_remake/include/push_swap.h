...
typedef void			(*t_op_funct)(t_ps_stack *stack_a, t_ps_stack *stack_b);
...
t_op_funct				decide_b_in_range(t_ps_stack *stack_a,
							t_ps_stack *stack_b);
...
void					easy_both_rotate(t_ps_node *target_a,
							t_ps_node *target_b);
...
t_op_funct				both_rotate_decider(t_ps_node *target_a,
							t_ps_node *target_b);
...
void					ps_node_addfront(t_ps_node **node_list,
							t_ps_node *node);
...
void					display_stacks(t_ps_stack *stack_a,
							t_ps_stack *stack_b);
